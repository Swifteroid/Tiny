...
extension CGImage {
    ...
    public func resize(fitting size: CGSize, interpolationQuality: CGInterpolationQuality? = nil) -> CGImage {
        self.resize(to: self.size.fitting(aspect: size), interpolationQuality: interpolationQuality)
    }
    ...
    public func resize(filling size: CGSize, interpolationQuality: CGInterpolationQuality? = nil) -> CGImage {
        self.resize(to: self.size.filling(aspect: size), interpolationQuality: interpolationQuality)
    }
}
