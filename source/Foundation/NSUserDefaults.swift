...
public struct KeyPath {
    ...
    /// Initializes a KeyPath with a string of the form "this.is.a.key.path".
    ...
    public var isEmpty: Bool { self.segments.isEmpty }
    public var path: String { self.segments.joined(separator: ".") }
